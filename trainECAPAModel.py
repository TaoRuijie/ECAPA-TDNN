...
parser.add_argument('--train_list', type=str,   default="/data08/VoxCeleb2/train_list_with_len.txt",     help='The path of the training list, eg:"/data08/VoxCeleb2/train_list.txt" in my case')
parser.add_argument('--train_path', type=str,   default="/data08/VoxCeleb2_orig/wav",                    help='The path of the training data, eg:"/data08/VoxCeleb2/wav" in my case')
parser.add_argument('--eval_list',  type=str,   default="/data08/VoxCeleb1/veri_test2.txt",              help='The path of the evaluation list, eg:"/data08/VoxCeleb1/veri_test2.txt" in my case')
parser.add_argument('--eval_path',  type=str,   default="/data08/VoxCeleb1/train",                       help='The path of the evaluation data, eg:"/data08/VoxCeleb1/test" in my case')
